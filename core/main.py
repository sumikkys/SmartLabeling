...
from routers import readProject,prompt, upload_image, polling,polling_ws, export, newProject, annotation_tools, switch_image
import argparse
...
app.include_router(polling_ws.router, tags=["Polling WS"])
